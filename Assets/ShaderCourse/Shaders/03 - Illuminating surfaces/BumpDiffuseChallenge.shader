//Add another slider to the code developed in the previous lecture 
//to turn the brightness over the entire model up and down.

Shader "Holistic/03 - Illuminating Surfaces/BumpDiffuseChallenge" 
{
	Properties {
