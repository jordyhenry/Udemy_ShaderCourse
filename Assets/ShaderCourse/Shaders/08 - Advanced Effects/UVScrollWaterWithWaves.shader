//Create a shader that makes waves on the surface of a mesh 
//as well as scrolling 2 images over the surface at different rates.
	...
	SubShader {
		...
		CGPROGRAM
			...
			void vert(inout appdata v, out Input o){
				...
				waveHeight += sin(t*2 + v.vertex.x * _Freq*2) * _Amp;
